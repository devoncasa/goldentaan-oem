    ...
    return (
        <section>
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[#4A4A4A]">โอกาสทางธุรกิจน้ำเชื่อมน้ำตาลโตนด OEM</h2>
                <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                    สำรวจความเป็นไปได้ในการสร้างแบรนด์น้ำเชื่อมน้ำตาลโตนด ซึ่งเป็นผลิตภัณฑ์สุขภาพระดับพรีเมียม ผ่านโมเดลการผลิตแบบ OEM ในประเทศไทย ตั้งแต่การวิเคราะห์ตลาดไปจนถึงการประเมินต้นทุนและผลกำไร
                </p>
            </div>
