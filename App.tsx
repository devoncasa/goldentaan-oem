    ...
    return (
        <>
            ...
            <main>
                ...
                <SectionWrapper sectionRef={sections.competitors} id="competitors" bgImage={bgImages[3]} bgColor="bg-[#F4EAE0]/[0.93]">
                    <CompetitorAnalysis />
                </SectionWrapper>

                <SectionWrapper sectionRef={sections.export} id="export" bgImage={bgImages[4]} bgColor="bg-[#FDF8F0]/[0.93]">
                    <ExportAnalysis />
                </SectionWrapper>

                <SectionWrapper sectionRef={sections.process} id="process" bgImage={bgImages[5]} bgColor="bg-[#EFE5D8]/[0.93]">
                    <OemProcess />
                </SectionWrapper>

                <SectionWrapper sectionRef={sections.costs} id="costs" bgImage={bgImages[6]} bgColor="bg-[#FDF8F0]/[0.93]">
                    <CostAnalysis />
                </SectionWrapper>

                <SectionWrapper sectionRef={sections.partners} id="partners" bgImage={bgImages[0]} bgColor="bg-[#F4EAE0]/[0.93]">
                    <Partners />
                </SectionWrapper>
                
                <SectionWrapper sectionRef={sections.about} id="about" bgImage={bgImages[1]} bgColor="bg-[#A3B18A]/[0.93]">
                    <About />
                </SectionWrapper>

                <SectionWrapper sectionRef={sections.contact} id="contact" bgImage={bgImages[2]} bgColor="bg-[#FDF8F0]/[0.93]">
                    <Contact />
                </SectionWrapper>

                <SectionWrapper sectionRef={sections.summary} id="summary" bgImage={bgImages[3]} bgColor="bg-[#EFE5D8]/[0.93]">
                    <Summary />
                </SectionWrapper>
            </main>
            <Footer />
